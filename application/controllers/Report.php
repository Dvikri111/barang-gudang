...
class Report extends CI_Controller
{
  ...
  public function barangKeluarManual()
  {
    ...
    //header Data
    $pdf->SetHeaderData('mediatech1.jpg',30,'Laporan Data','Barang Keluar',array(203, 58, 44),array(0, 0, 0));
      ...
      '<div>
        ...
        <table border="1">
          <tr>
            ...
            <th style="width:130px" align="center">Nama Supplier</th>
      ...
      '<div>
        ...
        <table border="1">
          ...
          foreach($data as $d){
            ...
            $html .= '<td align="center">'.$d->nama_supplier.'</td>';
