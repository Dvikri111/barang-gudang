            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_supplier" style="margin-left:220px;display:inline;">Nama Supplier</label>
                  <input type="text" name="nama_supplier" style="margin-left:117px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->nama_supplier?>">
                </div>
