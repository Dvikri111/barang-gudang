...
<head>
  ...
  <title>Mediatech Computer</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url('admin') ?>" class="logo">
        ...
        <span class="logo-lg"><b>Mediatech</b>Computer</span>
      </a>
                  ...
                  <form action="<?= base_url('admin/proses_databarang_masuk_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group" style="margin-bottom:40px;">
                        <label for="nama_barang" style="margin-left:220px;display:inline;">Nama Supplier</label>
                        <select class="form-control" name="nama_supplier" style="margin-left:75px;width:20%;display:inline;">
                          <option value="">-- Pilih --</option>
                          <option value="Alvindo Jaya">Alvindo Jaya</option>
                          <option value="Persada">Persada</option>
                          <option value="An's Komputer">An's Komputer</option>
                          <option value="Putra Sunda Elektronik">Putra Sunda Elektronik</option>
                        </select>
                      </div>
